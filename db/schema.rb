...
ActiveRecord::Schema.define(version: 20140716102128) do
  ...
  add_index "agencies", ["approved"], name: "index_agencies_on_approved", using: :btree
  ...
  add_index "rooms_stays", ["room_id", "stay_id"], name: "index_rooms_stays_on_room_id_and_stay_id", using: :btree
  ...
  create_table "stays", force: true do |t|
    ...
    t.integer  "agency_id"
    t.boolean  "waiting_for_transfer"
  end
